...
function [time_to_run, itrs, mse_err] = sdp_3_cooperative(theta_org,theta_0)
...
%% error
for i = 1:M
err(i) = (theta_pred(i,1)-theta_org(i,1))^2 + (theta_pred(i,2)-theta_org(i,2))^2;
end
%% RMSE
mse_err = sqrt(sum(err)/M);
itrs = cvx_slvitr;
