...
%% Generate data 
function [] = understanding_mle_tr_copy() 
data_gen_option = 5;
...
options_1 = optimoptions('lsqnonlin','Algorithm','trust-region-reflective','Display','iter-detailed','OutputFcn', @outfunc);
options_2 = optimoptions('lsqnonlin','Algorithm','trust-region-reflective','Display','iter-detailed','OutputFcn', @sap_optimplotfunccount); 
options_3 = optimoptions('lsqnonlin','Algorithm','trust-region-reflective','Display','iter-detailed','OutputFcn', @optimplotfval);
